                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-h-100">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <span class="text-muted mb-3 lh-1 d-block text-truncate">Subcategory</span>
                                    <h4 class="mb-3">
                                        <span class="counter-value" data-target="{{ $subcategoryCount }}">0</span>
                                    </h4>
                                    {{-- <div class="text-nowrap">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="mb-3">
                                        <span class="counter-value" data-target="{{ $orderCount }}">0</span>
                                    </h4>
                                </div>
                                <div class="flex-shrink-0 text-end dash-widget">
