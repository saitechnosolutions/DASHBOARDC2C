        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Sale Dashboard !</h4>
            ...
            <div class="div2">
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Gross Profit</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="0">0</span>
                                </h4>
            ...
            <div class="div8">
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Total Orders Delayed</span>
            ...
            <div class="div9">
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Top Selling Categories</span>
                                <h4 class="mb-3">
                                    <span class="counter-value" data-target="0">0</span>
                                </h4>
            ...
            <div class="div13">
                <div class="card card-h-100">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <span class="text-muted mb-3 lh-1 d-block text-truncate">Help</span>
                                No Requests For Now
                    ...
                    <div class="card-body px-0">
                        <div class="px-3" data-simplebar style="max-height: 386px;">
                            <div class="d-flex align-items-center pb-4">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-15 mb-1"><a href="" class="text-dark">Randy Matthews</a>
                                    </h5>
                            ...
                            <div class="d-flex align-items-center pb-4">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-15 mb-1"><a href="" class="text-dark">Vernon Wood</a>
                                    </h5>
                            ...
                            <div class="d-flex align-items-center pb-4">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-15 mb-1"><a href="" class="text-dark">Howard Rhoades</a>
                                    </h5>
                            ...
                            <div class="d-flex align-items-center pb-4">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-15 mb-1"><a href="" class="text-dark">Arthur Zurcher</a>
                                    </h5>
                            ...
                            <div class="d-flex align-items-center pb-4">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-15 mb-1"><a href="" class="text-dark">Angela Palmer</a>
                                    </h5>
                            ...
                            <div class="d-flex align-items-center pb-3">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="font-size-15 mb-1"><a href="" class="text-dark">Dorothy Wimson</a>
                                    </h5>
                            ...
                            <table class="table align-middle table-nowrap">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <h5 class="font-size-15"><a href="" class="text-dark"></a>Half
                                                    sleeve T-Shirt</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                <h5 class="font-size-15"><a href="" class="text-dark"></a>Green
                                                    color T-shirt</h5>
